...
urlpatterns = [
    path("produtos/todos/", views.buscar_produtos, name="buscar_produtos"),
    ...
    path("comprar/<slug:categoria_slug>/<int:produto_id>/", views.redirecionar_compra, name="redirecionar_compra"),
]